...
namespace UnitTests
{
    ...
    public class DependencyModelValidation
    {
        ...
        public void ValidateSFMLModel()
        {
            ...
            Assert.AreEqual(model.IncludeDir, "SFML-2.5.1/include/", "Incorrect include directory!");
            Assert.AreEqual(model.LibDir, "SFML-2.5.1/lib/", "Incorrect lib directory!");
            Assert.AreEqual(model.DllDir, "SFML-2.5.1/bin/", "Incorrect bin directory!");
        ...
        public void ValidateGLADModel()
        {
            ...
            Assert.AreEqual(model.IncludeDir, "include/glad/");
            Assert.AreEqual(model.LibDir, "", "There isn't a lib dir for GLAD!");
            Assert.AreEqual(model.DllDir, "", "There isn't a dll dir for GLAD!");
            Assert.IsTrue(model.DebugLibNames.Count == 0, "There are no lib names for GLAD!");
            Assert.IsTrue(model.ReleaseLibNames.Count == 0, "There are no lib names for GLAD!");;
            CollectionAssert.AreEqual(model.IncludeInProject, new List<string> { "src/glad.c" });
        }
        ...
        public void ValidateGLFWModel()
        {
            ...
            Assert.AreEqual(model.IncludeDir, "glfw-3.3.7.bin.WIN64/include/");
            Assert.AreEqual(model.LibDir, "glfw-3.3.7.bin.WIN64/lib-vc2019/");
            Assert.AreEqual(model.DllDir, "glfw-3.3.7.bin.WIN64/lib-vc2019/");
        ...
        public void ValidateGLMModel()
        {
            ...
            Assert.AreEqual(model.IncludeDir, "glm/");
